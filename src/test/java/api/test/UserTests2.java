...
public class UserTests2 {
	...
	public void testCreateUser()
	{
		...
		Response res=userEndpoint2.createUser(Userpayload);
	...
	public void testgetUser()
	{
		...
		Response res=userEndpoint2.getUser(this.Userpayload.getUsername());
		res.then().log().all();
		//res.statusCode();
	...
	public void testUpdateUser()
	{
		...
		Response res=userEndpoint2.updateUser(this.Userpayload.getUsername(), Userpayload);
		...
		*/
		...
		Response resAfterUpdate=userEndpoint2.getUser(this.Userpayload.getUsername());
	...
	public void testDeleteUser()
	{
		...
		Response res=userEndpoint2.deleteUser(this.Userpayload.getUsername());
		res.then().log().all();
